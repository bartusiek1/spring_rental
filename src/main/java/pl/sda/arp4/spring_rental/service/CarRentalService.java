...
import pl.sda.arp4.spring_rental.exception.CarNotAvailableException;
...
import pl.sda.arp4.spring_rental.repository.CarRentalRepository;
...
public class CarRentalService {
    ...
    public void rentCar(Long carId, RentCarRequest request) {
        ...
        if (optionalCar.isPresent()) {
            ...
            //jeśli nie jest wynajęty(to jest ok)     Tworzymy nowy obiekt CarRental,
            // ale bez dat, żeby klienci głupot nie wypisywali i nie było trzeba nullować pól
            // z istniejącego już konstruktora
            if (!isRented(car)) {
    ...
    public void returnCar(Long carId) {
        ...
        if (carOptional.isPresent()) {
            ...
            if(optionalCarRental.isPresent()) {
                ...
                // dokonujemy aktualizacji w bazie danych
                carRentalRepository.save(carRental);
                return;
            }
